...
public class TicketService {
    ...
    public Ticket createTicketResponse(UserPrincipal user, TicketRequest ticketRequest){
        ...
        Ticket ticket= new ModelMapper().mapRequestToTicket(user1,ticketRequest);
    ...
    public PagedResponse<TicketResponse> getAll(int page ,int size){
        ...
        List<TicketResponse> ticketResponses = tickets.stream().map((t) -> new ModelMapper().mapTicketToResponse(t)
    ...
    public TicketResponse getId(Long id){
        ...
        return new ModelMapper().mapTicketToResponse(ticket);
    }
